...
# K-fuscator
# Author  : piratassh
# Github  : https://github.com/piratassh
# Contact : https://m.me/piratassh
# Language: Python(3)
# Date    : 18-08-2021
...
def about():
    ...
    print(f"{cyan}[Author]    {purple} :[piratassh]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/piratassh]")
    print(f"{cyan}[Messenger] {purple} :[https://m.me/piratassh]")
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://github.com/piratassh/KasRoudra#My-Best-Works'")
            else:
                os.system("xdg-open 'https://github.com/piratassh/KasRoudra#My-Best-Works'")
            main()
